...
import sys
# import function from functions file, used for writing formatted tables
import functions as sh
...
try:
    ...
    script_output_folder = os.path.join(et.io.HOME, folder)
    ...
    sns.set_theme(context='notebook', style='white', palette='pastel', font='sans-serif', font_scale=1,
    ...
    # Define dataframe as variable iris. Use Pandas to read in file from the URL variable with the column names as
    # defined in the list = "names" Reference https://gist.github.com/curran/a08a1080b88344b0c8a7#file-iris-csv -
    # accessed 30/03/2023

    iris = pd.read_csv(url, names=["Sepal Length cms", "Sepal Width cms", "Petal Length cms", "Petal Width cms",
                                   "Species"])
    ...
    # function from functions.py to save file as a plotly formatted table
    # function is based on code snippet from
    # https://www.delftstack.com/howto/python-pandas/pandas-png/#convert-pandas-dataframe-table-into-png-image-with-plotly-and-kaleido
    # - accessed 30/03/2023
    sh.table_save(missing_values_table_csv, f"{script_output_folder}/missing_data_summary_{time_stamp}.png")
    ...
    print(f"Check complete. Output saved to {script_output_folder} folder as missing_data_summary.png")
    ...
    # function from functions.py to save file as a plotly formatted table
    sh.table_save(data_summary, f"{script_output_folder}/data_summary_{time_stamp}.png")
    ...
    print(f"Data summary table complete. Output saved to {script_output_folder} folder as data_summary.png")

    # # # # # Create summary table of data for appendix 1 # # # # #

    print('Creating a summary table of full data set..........')

    sh.table_save(iris, f"{script_output_folder}/full_data_set_table_{time_stamp}.png")

    print(f"Full data set summary table complete. Output saved to {script_output_folder} "
          f"folder as full_data_set_table.png")

    # # # # # Output Variables to txt file # # # # #

    print("Creating a summary of each variable..........")

    # Output a summary of each variable to a text file - https://www.statology.org/pandas-to-text-file/ accessed
    # 30/03/2023 variable that specifies path for outputting of .txt file
    ...
    plot.map(sns.histplot, "Sepal Length cms", kde=True).set(title='Sepal Length Distribution')  # add a
    # title to the plot https://www.statology.org/seaborn-title/ - accessed 22/04/2023
    plt.legend()
    ...
    # 20/04/2023
    print(f'Histograms have been saved in the {script_output_folder} folder')
    ...
    print(f'Boxplots have been saved in the {script_output_folder} folder')
    ...
    plt.ylim(0.75, 2)  # https://stackoverflow.com/questions/33227473/how-to-set-the-range-of-y-axis-for-a-seaborn
    # -boxplot
    # accessed 20/04/2023
    ...
    # the following lines of code are based on -
    # https://www.geeksforgeeks.org/detect-and-remove-the-outliers-using-python/ accessed- 10/04/2023 Define Q1
    # variable for numpy percentile method for the dataset column sepal width
    ...
    print(f'Outlier demonstration has been saved to {script_output_folder} folder')
    ...
    print(f'Violin plots have been saved to the {script_output_folder} folder')
    ...
    # https://stackoverflow.com/questions/69660844/count-not-conver-string-to-float-using-iris-dataset - accessed
    # 10/04/2023
    ...
    print(f'Heatmap has been saved to the {script_output_folder} folder')
    ...
    print(f'Pairplots saved to the {script_output_folder} folder')
    ...
    print(f'Andrew\'s Curves plot saved to the {script_output_folder} folder')
    ...
    print(f'Parallel coordinates plot saved to {script_output_folder} folder')
    ...
    print(f'Lag plot saved to {script_output_folder} folder')

    print(f'\nThe script has completed successfully. All tables and plots have been saved in '
          f'the "{script_output_folder}" folder.')

# except block to raise error if the user neglects to pass an output when running the script from the CLI. Will direct
# the user to input an output folder
except IndexError:
    print('Error: An output folder must be supplied in the '
          'command line as an argument e.g. python analysis.py output_folder')
# except block to raise error if the user neglects to pass an output when running the script from the CLI. Will direct
# the user to input an output folder
